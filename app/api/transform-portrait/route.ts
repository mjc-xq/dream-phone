...
function build90sPrompt(): string {
  ...
  const hairAndClothes = [
    "VIBE TARGET — early-90s American teen sitcom (Bayside High era, 1989-1993). Sunny California public school in pastel and neon. The subject looks like they belong in a Memphis-pattern hallway in 1991. Big hair, bright colors, oversized fits.",
    "HAIR — pick a high-volume early-90s style that suits the subject. Masculine presentation: tall slicked-back wave with mousse, surfer curtain bangs over the brow, gelled crown with razor part, blow-dried feathered side-part, high-top fade with sharp temple lines and brushed-up crown (especially for Black/brown teens), bowl cut for younger teens, mullet only if it fits. Feminine presentation: crimped voluminous side ponytail with a bright scrunchie, ratted-and-hairsprayed sky-high bangs, half-up clipped with butterfly clips, big permed curls, claw-clip waterfall. Hair color and texture stay close to the original.",
    "CLOTHING — one mall-store outfit in the early-90s teen-sitcom palette. Strong hot pink / teal / electric yellow / lime / royal purple / black accents. Geometric Memphis prints (squiggles, dots, triangles), color-blocked windbreakers, denim jackets with rolled cuffs, oversized graphic sweatshirts, plaid flannels buttoned to the neck, slouchy turtlenecks under denim vests, neon polos, varsity letterman jackets, baggy chambray button-downs over a tee, baby tees with chokers. Light layering: shirt-over-shirt, jacket-over-tee. Accessories sparing and period-correct: scrunchie, choker, hoop earrings, slap bracelet, plastic-banded watch.",
    "AVOID: any reference to specific TV shows or characters by name in the image. The vibe is generic to the era — Memphis patterns and bright colors, not branded properties.",
  ].join("\n");
